 ...
 */
@Entity
@Table(name = "dbd_purchase_registered"
        ,uniqueConstraints=@UniqueConstraint(columnNames={"registeredID", "purchaseID","userId"}))
public class DbdPurchaseRegistered extends AbstractPojo{
    private Integer id;
    private Integer rId;
    private Integer pId;    
    ...
    @Column(name = "purchaseID", unique = false ,columnDefinition = "int", nullable = false)
...
//
    ...
    @Column(name = "purchaseOther", nullable = true, length = 100,insertable = true, updatable = true)
    ...
    public boolean equals(Object obj) {
        ...
        final DbdPurchaseRegistered other = (DbdPurchaseRegistered) obj;
